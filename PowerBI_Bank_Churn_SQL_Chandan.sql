...
With RankedSalaries as (
	...
	From customerinfo 
	where month(BankDOJ) IN (1,2,3)) #Assumed Last Quarter to be January, February and March as per Banking standard.
Select
	CustomerId,
    Surname,
    EstimatedSalary,
...
From exitcustomer e
Left Join bank_churn b on e.ExitID = b.ExitID
Group By e.ExitID;
...
inner join bank_churn b on b.CustomerID = c.CustomerID
Where b.ActiveID = 1 and b.Tenure > 5
Group By g.GeographyLocation;
